<nav class="top-menu">
    <ul class="menu-main">
        ...
        <li><a href="" class="current">Заказать страховку для Путшествий</a></li>
...
<form action="" class="air" method="post">
    <div class="form-inner">
        ...
        <div class="form-row">
            <p>Выберите часть света:
                <select name="svet">
                    <option disabled>Выберите часть света</option>
                    <option value="Европа">Страны Европы</option>
            ...
            <p>Введите возраст застрахованного:
                <input type="number" name="Vozrast" min="0">
            </p>
...
<style>/* для элемента input c type="checkbox" */
    ...
    .custom-checkbox>input:focus+span::before {
        box-shadow: 0 0 0 0.2rem #f8c197;
    }
...
function calcula()
{
    ...
    if ($svet == "Европа") {
        ...
        $coef_svet = 2.0;
    } elseif ($svet == "Все страны") {
        $coef_svet = 2.0;
    }
    $vozrast = $_POST['Vozrast'];
    if ($vozrast >= 0 and $vozrast <= 9) {
        $coef_vozrast = 1.2;
    } elseif ($vozrast > 9 and $vozrast <= 17) {
        $coef_vozrast = 1.4;
    } elseif ($vozrast > 17 and $vozrast <= 64) {
        $coef_vozrast = 1.6;
    }
    $pok = $_POST['pokr'];
    if ($pok == 30000) {
    ...
    $result =$baz_stavka * $coef_interval * $coef_pok  * $coef_vozrast * $coef_svet + $covid;
    return $result;
}
